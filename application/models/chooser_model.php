...
class Chooser_Model extends MY_Model {
    ...
    function get_data_tabel_input()

    {

        $sql = "select p.*, (select input_time from fp_chosseds c where c.id_chosser=p.id_chooser) as input_time from fp_choosers p;";
    ...
    function get_data_pencoblos()

    {

        $sql = "SELECT * FROM `fp_choosers` WHERE `id_chooser` in (select id_chosser from `fp_chosseds` where id_chosser IS NOT NULL);";
